export const dictionary = {
  ...
  'services.items.visuals.ariaChoose': { ua: 'Обрати послугу: AI-генерація візуалів та брендинг', en: 'Choose this service: AI Visuals & Branding' },
  'services.items.video.title': { ua: 'AI-відео та моушн-дизайн', en: 'AI Video & Motion Design' },
  'services.items.video.subtitle': { ua: 'Промо-ролики та Reels без камери й студії', en: 'Promo videos and Reels — no camera, no studio' },
  'services.items.video.ariaChoose': { ua: 'Обрати послугу: AI-відео та моушн-дизайн', en: 'Choose this service: AI Video & Motion Design' },
  ...
  'services.items.social.ariaChoose': { ua: 'Обрати послугу: AI-контент для соцмереж', en: 'Choose this service: AI Content for Social Media' },
  ...
  'services.items.consulting.ariaChoose': { ua: 'Обрати послугу: Консалтинг з впровадження AI', en: 'Choose this service: AI Consulting' },
  ...
  'portfolio.authenticity': { ua: 'Кожне зображення тут — реальна AI-генерація: без стокових фото і без фотосесій.', en: 'Every image here is a real AI generation — no stock photos, no photoshoots.' },
  ...
  'advantages.items.2.title': { ua: 'Без шаблонів під копірку', en: 'No copy-paste templates' },
  'advantages.items.2.desc': { ua: 'Кожен проєкт розробляється з нуля під ваш бренд, а не підганяється під готовий шаблон', en: 'Every project is built from scratch for your brand, not adjusted from a template' },
  'advantages.items.3.title': { ua: 'Не треба шукати підрядників', en: 'No contractors to chase' },
  'advantages.items.3.desc': { ua: 'Візуал, відео, текст і автоматизація — в одній команді, без пошуку окремого фахівця під кожен формат', en: 'Visuals, video, copy and automation in one team — no separate specialist to find for each format' },
  'advantages.items.4.title': { ua: 'Бачите кожен крок', en: 'You see every step' },
  'advantages.items.4.desc': { ua: 'Узгоджуємо кожен етап разом з вами — без сюрпризів у фінальному результаті', en: 'We align on every stage together — no surprises in the final result' },
  ...
  'service.video.tagline': { ua: 'Промо-ролики та Reels без камери й студії', en: 'Promo videos and Reels — no camera, no studio' },
  ...
  'service.automation.tagline': { ua: 'Бот відповідає клієнтам цілодобово', en: 'A bot that replies to clients around the clock' },
